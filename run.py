...
API_SERVICE_NAME = 'gmailpostmastertools'
API_VERSION = 'v1beta1'
...
def get_traffic_stats(service, domain_name, date):
  ...
  Returns:
    ...
    try:
        ...
        traffic_stats_prep = service.domains().trafficStats().get(name=query)
        traffic_stats = traffic_stats_prep.execute()
        print(traffic_stats)
...
def test_api_request():
  ...
  if not domains:
      ...
      for domain in domains['domains']:
          print(domain)
          data.append(domain)
          data.append(get_traffic_stats(service, domain['name'].split('/')[-1], '20210101'))
